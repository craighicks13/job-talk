        ...
        <div className="hidden lg:sticky lg:top-0 lg:flex lg:h-full lg:w-16 lg:flex-none lg:items-center lg:whitespace-nowrap lg:py-12 lg:text-sm lg:leading-7 lg:[writing-mode:vertical-rl]">
          ...
          <span className="block h-fit ">
            ...
            >
              ...
              <EmailIcon className="h-6 w-6 rotate-90 fill-slate-400 group-hover:fill-slate-600" />
            </Link>
          </span>
        </div>
            ...
            >
              {[
                [
                  'Spotify',
                  SpotifyIcon,
                  'https://open.spotify.com/show/5d1tPxU7lvQWEPuN74BMgp?si=Yw8EoCLATHCd5bklzhiYaw',
                ],
                [
                  'Apple Podcast',
                  ApplePodcastIcon,
                  'https://podcasts.apple.com/ca/podcast/the-job-talk-podcast/id1615436433',
                ],
                [
                  'RSS Feed',
                  RSSIcon,
                  'https://media.rss.com/thejobtalk/feed.xml',
                ],
                [
                  'YouTube Channel',
                  YouTubeIcon,
                  'https://www.youtube.com/channel/UCpmmC9kSOcCn0HUCqakn34Q/featured',
                ],
              ].map(([label, Icon, link]) => (
        ...
        <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4">
          ...
          <div className="mt-10">
            ...
            >
              ...
              <EmailIcon className="h-6 w-6 fill-slate-400 text-sm group-hover:fill-slate-600" />
            </Link>
          </div>
        </div>
      </footer>
